...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    interface ForecastAdapterClickHandler {
        void onItemClick(String item);
    }

    final private ForecastAdapterClickHandler mForecastClickHandler;
    ...
    public ForecastAdapter(ForecastAdapterClickHandler forecastAdapterClickHandler) {
        mForecastClickHandler = forecastAdapterClickHandler;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mForecastClickHandler.onItemClick(weatherData);
        }
